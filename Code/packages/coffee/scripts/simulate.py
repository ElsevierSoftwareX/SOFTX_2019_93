...
# Parse times
parser.add_argument('-terrN','-times-error-numeric',nargs='+',help=\
"""A list of all times for which error calculations should be performed against the highest resolution numeric data. This list will also be used for visualisation of error data.""")

parser.add_argument('-terrE','-times-error-exact',nargs='+',help=\
"""A list of all times for which error calculations should be performed against the exact values of the function. This list will also be used for visualisation of error data.""")
...
errorNum_run += ["python '%s' %s %s -Lp '2' numer '%s'"%\
...
errorExa_run = []
command = os.path.join(path,"error.py")
errorExa_run += ["python '%s' %s %s -Lp '2' exact '%s'"%\
