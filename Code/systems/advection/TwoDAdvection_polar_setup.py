...
"""This script contains the settings for a simulation.""")
...
#default_file_location = "/localhome/bwhale/"
default_file_name = "2DAd_polar_%i-%s-%s-%s.hdf"%\
    (MPI.COMM_WORLD.rank,year,month,day)
